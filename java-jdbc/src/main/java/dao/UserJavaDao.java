...
public class UserJavaDao {
	...
	public List<Usuario> listar() throws SQLException {
		...
		ResultSet resultado = statement.executeQuery(); //realiza consulta ao banco de dados e armazena os dados na variável resultado
		...
		while (resultado.next()) { // percorre os dados em resultado enquanto houver dados
			...
			/* manipulando os dados obtidos do banco de dados e adicionando na lista do tipo de dado no banco*/
